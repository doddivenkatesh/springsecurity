...
public class AbstractDocumentService {
	...
	public static final String CONFIGURATION_XCONF = "templates/configuration.xconf";
	...
	public void generateDocument(HttpServletResponse response, String xmlTemplate) {
		try {
			...
			DefaultHandler defaultHandler = fopFactory.newFop(MimeConstants.MIME_PDF, response.getOutputStream())
				.getDefaultHandler();
